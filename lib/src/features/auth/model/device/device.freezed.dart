...
class _$DeviceImpl implements _Device {
  ...
  @override
  String toString() {
    return 'Device(id: $id, deviceName: $deviceName, osDevice: $osDevice, modifiedDate: $modifiedDate, isMobile: $isMobile, deviceCode: $deviceCode)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, id, deviceName, osDevice,
      modifiedDate, isMobile, deviceCode);
